...
/**
 * Provides testing sendOneNotification method of MPNSToastSender class.
 * {@link MPNSToastSender}
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ MPNSToastSender.class, URLConnection.class, URL.class, OutputStreamWriter.class})
public class MPNSToastSenderTest {
    ...
    public void set() throws Exception {
        wpConfig = new WPConfig("Page2.xaml");
    ...
    /**
     * Tests what happens after sending an unsuccessful toast notification to a Windows Phone device with an invalid device id.
     * @throws Exception
     */
    @Test
    public void sendNotification_WhenPushingFail_ReturnsUnsuccessfulDelete() throws Exception {
        ...
        ResultModel actualResultModel = new MPNSToastSender(wpConfig).sendOneNotification(message);
        assertEquals(actualResultModel.getResultType(), ResultType.UNSUCCESS_DELETE);
    }

    /**
     * Tests what happens after sending an unsuccessful toast notification to a Windows Phone device.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests what happens after sending an successful toast notification to a Windows Phone device.
     * @throws Exception
     */
    @Test
